...
import img1 from '../../assets/WebDev/SquidGame.png';
import img2 from '../../assets/WebDev/VoyageX.png';
import img3 from '../../assets/WebDev/building.png';
import img4 from '../../assets/WebDev/caffineCove.png';
import img5 from '../../assets/WebDev/gardenView.png';
import img6 from '../../assets/WebDev/institute.png';
import img7 from '../../assets/WebDev/management.png';
import img8 from '../../assets/WebDev/mealMetrics.png';
import img9 from '../../assets/WebDev/signage.png';
import img10 from '../../assets/WebDev/store.png';

const workImages = [img1, img2, img3, img4, img5, img6, img7, img8, img9, img10];
    ...
    <div className="bg-[#050505] min-h-screen text-white font-sans overflow-x-hidden relative">
      ...
      <section className="relative w-full min-h-[90vh] pt-48 pb-20 px-6 flex flex-col items-center justify-center text-center z-10">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide uppercase text-white/80">Innovation Focused</span>
        </motion.div>
        ...
        >
          <h1 className="text-[14vw] sm:text-[100px] md:text-[140px] lg:text-[180px] font-black leading-[0.85] tracking-tighter italic uppercase text-white relative">
            <span className="block relative z-10 hover:text-transparent hover:-webkit-text-stroke-[2px] hover:-webkit-text-stroke-white transition-all duration-500">Web</span>
        ...
        >
          Build a powerful digital presence. We craft high-performance websites and web applications that are responsive, secure, and visually stunning.
        </motion.p>

        {/* Hero Interactive Button */}
        <motion.a
          href="https://wa.me/923134409152?text=Hello%20Minarix!%20I%20would%20like%20to%20start%20a%20web%20development%20project."
          target="_blank"
              ...
              {sliderImages.map((src, idx) => (
                ...
                >
                  ...
                  >
                    <img 
                      src={src} 
                      alt={`Web Development Work ${idx + 1}`} 
