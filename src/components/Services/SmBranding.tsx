...
import img1 from '../../assets/SmBranding/Sm1.jpeg';
import img2 from '../../assets/SmBranding/Sm2.jpeg';
import img3 from '../../assets/SmBranding/Sm3.jpeg';
import img4 from '../../assets/SmBranding/Sm4.jpeg';
import img5 from '../../assets/SmBranding/Sm5.jpeg';
import img6 from '../../assets/SmBranding/Sm6.jpeg';
import img7 from '../../assets/SmBranding/Sm7.jpeg';
import img8 from '../../assets/SmBranding/Sm8.jpeg';

const workImages = [img1, img2, img3, img4, img5, img6, img7, img8];
const sliderImages = [...workImages, ...workImages, ...workImages]; // Duplicated for slider effect

const SmBranding: React.FC = () => {
    ...
    <div className="bg-[#050505] min-h-screen text-white font-sans overflow-x-hidden relative">
      ...
      <section className="relative w-full min-h-[90vh] pt-48 pb-20 px-6 flex flex-col items-center justify-center text-center z-10">
        ...
        >
          ...
          <span className="text-sm font-medium tracking-wide uppercase text-white/80">Brand Identity Focused</span>
        </motion.div>
        ...
        <motion.div
          ...
          className="mb-8"
        >
          <h1 className="text-[14vw] sm:text-[90px] md:text-[120px] lg:text-[160px] font-black leading-[0.85] tracking-tighter italic uppercase text-white relative">
            <span className="block relative z-10 hover:text-transparent hover:-webkit-text-stroke-[2px] hover:-webkit-text-stroke-white transition-all duration-500">Social Media</span>
        ...
        >
          Shape how the world sees your brand. We design impactful and consistent social media identities that connect with your audience and build lasting relationships.
        </motion.p>
        ...
        >
          <span className="relative z-10 text-lg group-hover:text-[#01C000] transition-colors duration-300">Elevate Your Brand</span>
              ...
              {sliderImages.map((src, idx) => (
                ...
                >
                  ...
                  >
                    <img 
                      src={src} 
                      alt={`Social Media Branding Work ${idx + 1}`} 
